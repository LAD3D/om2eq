...
autoload :Sphere, File.join(ROOT_DIR, 'sphere.rb')
...
autoload :CrossProductVector, File.join(CONSTRUCTIONS_DIR, 'cross_product_vector.rb')
...
autoload :SphereByCenter, File.join(CONSTRUCTIONS_DIR, 'sphere_by_center.rb')
